...
with_node \
  ...
  --target "/Users/meherhowji/Workspace/idera/codebase/react-native-fusioncharts/examples/bare-react-native-app/chart/ios/Pods/Target Support Files/Pods-chart/ExpoModulesProvider.swift" \
  --platform "apple" \
